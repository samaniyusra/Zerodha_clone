        ...
        <div className="container">
            ...
            <div className="row mb-5 p-2">
                ...
                <div className="col-lg-6 col-md-8 col-sm-12 mt-5 p-3 lh-lg">
                    ...
                    <p>
                        hurdles she faced during his decade long stint as a trader. Today, Zerodha has changed the landscape of the Indian broking industry.
                    </p>
                    <p>
                    ...
                    <p > <a style={{textDecoration: "none"}}href="">Connect on Homepage </a> /  <a style={{textDecoration: "none"}}href=""> radingQnA</a>/  <a style={{textDecoration: "none"}}href=""> Twitter</a></p>
                </div>
            </div>
        </div>
